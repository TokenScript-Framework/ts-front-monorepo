...
export class EthUtils {
  ...
  public static encodeTransactionParameter(type: string, value: any) {
    ...
    throw new Error(
      "Ethereum argument encoding for type " + type + " is not defined",
    );
  }
   ...
   * @param outputType
   */
  public static tokenScriptOutputToEthers(outputType: any) {
    switch (outputType) {
      case "utf8":
        return "string";
    }
   ...
   * @param resultObject
   */
  public static convertFunctionResult(resultObject: any): any {
   ...
   * @param data
   */
  public static bigIntsToString(data: any): any {
  ...
  public static calculateDecimalValue(
  ...
  public static calculateIntValue(value: string | number, decimals: number) {
    ...
    const convertedString = new BigNumber(value)
